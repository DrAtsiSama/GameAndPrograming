...
function add_apple() -- random apple position (0-29,0-29)
...
function game_draw()
  ...
  love.graphics.setColor(0.7, 0.35, 0.4, 1.0) -- draw snake body (tails)
...
function game_update()
  ...
  if snakeX == appleX and snakeY == appleY then -- IF snake eat Apple
    add_apple()
